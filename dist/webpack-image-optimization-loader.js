...
var updateImageInfo = function updateImageInfo(imageInfo, fileName, breakpoint, fileSrc) {
  imageInfo[fileName] = _objectSpread(_objectSpread({}, imageInfo[fileName]), {}, _defineProperty({}, breakpoint, fileSrc));
};
var optimizeOriginalImage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(file, imageInfo, fileName, filePath) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          updateImageInfo(imageInfo, fileName, 'original', filePath);
          updateImageInfo(imageInfo, fileName, 'optimized', path.join('/optimized', "".concat(fileName, ".webp")));
          _context.next = 4;
          return sharp(file).webp().toFile(path.join(resultFolderPath, "".concat(fileName, ".webp")), function (err) {
            if (err) {
              console.log(err);
              throw err;
            }
  ...
  return function optimizeOriginalImage(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
var saveResultToFile = function saveResultToFile(imageInfo) {
  fs.writeFileSync(resultFilePath, JSON.stringify(imageInfo));
};
var processImage = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(file, fileName, imageInfo, filePath) {
    var fileSize;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 2;
          _context3.next = 5;
          return Promise.all(Object.entries(SCREEN_BREAK_POINT).map( /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref3) {
              var _ref5, breakpoint, breakpointWidth, isResizingNeeded, fileSrc;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    _ref5 = _slicedToArray(_ref3, 2), breakpoint = _ref5[0], breakpointWidth = _ref5[1];
                    isResizingNeeded = breakpointWidth < fileSize.width;
                    fileSrc = isResizingNeeded ? "".concat(fileName, ".").concat(breakpoint, ".webp") : "".concat(fileName, ".webp");
                    updateImageInfo(imageInfo, fileName, breakpoint, path.join('/optimized', fileSrc));
                    return _context2.abrupt("return", new Promise(function (resolve) {
                      if (isResizingNeeded) {
                        sharp(file).resize(breakpointWidth).webp().toFile(path.join(resultFolderPath, "".concat(fileName, ".").concat(breakpoint, ".webp")), function (err) {
                          if (err) {
                            console.log(err);
                            throw err;
                          } else {
        ...
        case 5:
          _context3.next = 7;
          return optimizeOriginalImage(file, imageInfo, fileName, filePath);
        case 7:
          _context3.next = 13;
          break;
        case 9:
