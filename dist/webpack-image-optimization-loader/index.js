...
var _saveResultToFile = require("./utils/saveResultToFile");
...
var DEFAULT_SCREEN_BREAK_POINT = {
  sm: 640,
  md: 768,
  lg: 1024,
  xl: 1280
...
function _ref() {
  _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var options, processImageOptions, callback, currentFilePath, fileBuffer, currentFileName, release, imageInfo, resultJsonFile, isDuplicatedName;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          _context.prev = 9;
          _context.next = 12;
          return _promises["default"].access(resultFilePath);
        case 12:
          _context.next = 22;
          break;
        case 14:
          ...
          _context.next = 19;
          return _promises["default"].writeFile(resultFilePath, JSON.stringify({}));
        case 19:
          _context.next = 22;
          break;
        case 21:
        ...
        case 22:
          _context.next = 24;
          return _properLockfile["default"].lock(resultFilePath, {
            retries: 5
          });
        case 24:
          ...
          imageInfo = {};
          _context.next = 29;
          return _promises["default"].access(resultFilePath).then(function () {
            return true;
          })["catch"](function () {
            return false;
          });
        case 29:
          ...
          _context.next = 32;
          return _promises["default"].readFile(resultFilePath, "utf-8");
        case 32:
          resultJsonFile = _context.sent;
        ...
        case 34:
          ...
          if (isDuplicatedName) {
            console.error("Error: Image with name ".concat(currentFileName, " already exists in ").concat(DEFAULT_RESULT_FILE_NAME, "  \n"), "duplicated path: ".concat(currentFilePath, " and ").concat(imageInfo[currentFileName].original));
            process.exit(1);
          } else {
        ...
        case 41:
          _context.next = 43;
          return (0, _saveResultToFile.saveResultToFile)(imageInfo, resultFilePath);
        case 43:
          callback(null, fileBuffer);
        case 44:
          _context.prev = 44;
    ...
    }, _callee, this, [[8, 50], [9, 14], [25,, 44, 48]]);
  }));
  return _ref.apply(this, arguments);
}